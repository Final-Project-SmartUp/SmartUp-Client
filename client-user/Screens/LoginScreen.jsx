        ...
        <ScrollView>
            <View style={styles.container}>
                ...
                <View style={styles.textInputContainer}>
                    ...
                    <TextInput placeholderTextColor="#C0C0C0" placeholder="Email" editable multiline numberOfLines={4} maxLength={40} value={email} onChangeText={(email) => onChangeEmail(email)} style={styles.textInput} />
