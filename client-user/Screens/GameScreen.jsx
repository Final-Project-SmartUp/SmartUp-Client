  ...
  return (
    <View style={styles.container}>
      <View style={styles.profileScoreContainer}>
        ...
        <View
          style={styles.profileScoreLeftContainer}
        >
          <View
            style={styles.profileScoreLeft}
          >
            <Text>Beauty</Text>
            <Text>100</Text>
          </View>
      ...
      <View
        style={styles.questionBoxContainer}
      >
        <View
        ...
        >
          ...
          >
            Which Apple computer was the first personal computer sold with a GUI
          </Text>
        </View>
      </View>
      <View
